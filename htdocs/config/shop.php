		...
		'html' => [
			'catalog' => [
				 ...
				 'detail' => [
					 ...
					 // 'template-body' =>
						// 	 base_path('vendor/aimeos/ai-client-html/client/html/templates/catalog/detail/body-standard-v1'),
					 'domains' => [
 							'media',
 						  'media/property',
 							// 'price',
			...
			'basket' => [
				// 'template-body' =>
				// 		base_path('vendor/aimeos/ai-client-html/client/html/templates/basket/standard/body-standard-v1'),
				'mini' => [
					// 'template-body' =>
					//     base_path('vendor/aimeos/ai-client-html/client/html/templates/basket/mini/body-standard-v1'),
				],
				'cache' => [
