		...
		<div class="navbar-default-white navbar-fixed-top">
			<div class="container-fluid"><!-- container -->
					...
					<div class="row p-3-vh">
							...
							<img class="h-100 init" src="<?php echo e(asset( 'aimeos/' . ( app( 'aimeos.context' )->get()->locale()->getSiteItem()->getLogo() ?: '../vendor/shop/themes/default/assets/logo.png' ) )); ?>" title="Logo">
							<img class="h-100 show" src="<?php echo e(asset( 'aimeos/' . ( app( 'aimeos.context' )->get()->locale()->getSiteItem()->getLogo() ?: '../vendor/shop/themes/default/assets/logo.png' ) )); ?>" title="Logo">
							</a>
							...
							<ul class="navbar-nav align-self-center">
								...
								<?php else: ?>
									<li class="nav-item login profile dropdown">
										<a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false" title="<?php echo e(__( 'Account' )); ?>"><span class="name"><i class="fas fa-user"></i></span> <span class="caret"></span></a>
										<ul class="dropdown-menu dropdown-menu-end login" role="menu">
											...
											<li class="dropdown-item"><form id="logout" action="<?php echo e(airoute( 'logout' )); ?>" method="POST"><?php echo e(csrf_field()); ?><button class="btn btn-light" data-mdb-ripple-color="dark"><span class="name"><?php echo e(__( 'Logout' )); ?></span></button></form></li>
										</ul>
									</li>
								<?php endif; ?>
							</ul>
...
<?php /**PATH C:\Users\boukl\github\maisonfraiche.com\htdocs\packages\maison-fraiche-shop\views/base.blade.php ENDPATH**/ ?>