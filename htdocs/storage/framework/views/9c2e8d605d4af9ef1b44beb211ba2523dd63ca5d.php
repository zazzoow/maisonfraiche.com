        ...
        <div class="container size-1">
          <div class="popup-inner">
            ...
            <div class="main-caption text-center color-type-2">
              <h2 class="h2 tt"><?php echo e(__('Log in')); ?></h2>
            </div>
            <div class="empty-sm-30 empty-xs-30"></div>
            <form method="post" action="<?php echo e(route('login')); ?>">
              ...
              <div class="text-center">
                <div class="page-button button-style-1 type-2">
                  <input type="submit">
                  <span class="txt"><?php echo e(__('Log in')); ?></span><i></i>
                </div>
              </div>
            </form>
...
<?php /**PATH /home/zazzoow/sites/maisonfraiche.com/htdocs/packages/maison-fraiche-shop/views/base.blade.php ENDPATH**/ ?>